...
# Installing Latest Hashicorp Terraform (v0.11.9)
RUN curl -s https://releases.hashicorp.com/terraform/0.11.9/terraform_0.11.9_linux_amd64.zip > terraform_0.11.9_linux_amd64.zip && \
    unzip terraform_0.11.9_linux_amd64.zip -d /bin && \
    rm -f terraform_0.11.9_linux_amd64.zip
