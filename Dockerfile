...
# Installing Latest Hashicorp Terraform (v0.11.11)
RUN curl -s https://releases.hashicorp.com/terraform/0.11.11/terraform_0.11.11_linux_amd64.zip > terraform_0.11.11_linux_amd64.zip && \
