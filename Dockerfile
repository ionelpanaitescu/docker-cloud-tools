...
# Installing Latest Hashicorp Terraform (v0.11.10)
RUN curl -s https://releases.hashicorp.com/terraform/0.11.10/terraform_0.11.10_linux_amd64.zip > terraform_0.11.10_linux_amd64.zip && \
