...
# Installing Latest Hashicorp Terraform (v0.12.4)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.4/terraform_0.12.4_linux_amd64.zip > terraform_0.12.4_linux_amd64.zip && \
    unzip terraform_0.12.4_linux_amd64.zip -d /bin && \
    rm -f terraform_0.12.4_linux_amd64.zip
